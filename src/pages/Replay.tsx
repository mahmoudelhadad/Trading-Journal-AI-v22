...
import { HistoricalImportPanel, ReplayChart, ReplayControls, ReplayTimeReadout } from '@components/replay/index.js';
...
export function ReplayPage({ snapshot, actions }: ReplayPageProps) {
